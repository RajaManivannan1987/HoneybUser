...
//                                startActivity(new Intent(LocationCheckActivity.this, VendorActivity.class).putExtra(ConstantValues.vendorId, id).putExtra(ConstantValues.isFromNotification, true));
                                break;
                            case vendorAlert:
                                startActivity(new Intent(LocationCheckActivity.this, VendorDetailActivity.class).putExtra(ConstandValue.vendorId, id).putExtra("notificationType", vendorAlert));
                                break;
                            case message:
